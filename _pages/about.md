...
![](images/img1.png)
<div style="text-align: center;">Figure 1:  Structural Analogy Between Protein Sequences and Natural Language </div>
...
<div style="text-align: center;">Table 3. Comparison of Greedy, Beam, and Top‑k sampling strategies</div>
...
<div style="text-align: center;">Figure 4:Sampling outputs for GPT2-like language models on both text (a–d) and protein sequences (e–h). Repetitive sequences are generated by greedy and beam search; natural-like diversity emerges with random top-k sampling (g, h).</div>
...
<div style="text-align: center;">Table 4. Comparison of Structural Order Between Natural and ProtGPT2-Generated Proteins </div>
...
<div style="text-align: center;">Figure 5: Secondary structure comparison </div>
...
<div style="text-align: center;">Figure 6: Pairwise sequence identities vs. alignment length for each of the datasets </div>
...
<div style="text-align: center;">Figure 7: a. Average Rosetta energy units per residue for the three datasets. b. Root mean square deviation (RMSD) distribution for each MD dataset as computed by averaging RMSDs independently for each trajectory, represented as a boxplot.  </div>
...
<div style="text-align: center;">Figure 8. Network of structural relationships between ProtGPT2-generated and natural proteins. Each dot represents a protein. White nodes are ProtGPT2 sequences connected to known structural classes. </div>
...
- **Conditional and Prompt-Based Generation :** Enabling control over structural or functional attributes during generation (e.g., via conditioning tokens or prompt embeddings) could dramatically expand design utility.
